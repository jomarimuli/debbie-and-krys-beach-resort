...
export default function Edit({ gallery }: PageProps & { gallery: Gallery }) {
    const [currentImage, setCurrentImage] = useState<string | null>(gallery.image_url);
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(galleries.update.url({ gallery: gallery.id }), {
            forceFormData: true,
        });
    };
                ...
                <CardContent>
                    <form onSubmit={submit} className="space-y-5">
                        <div className="space-y-2">
                            <Label className="text-sm cursor-text select-text">Image</Label>
                            ...
                            {!newImagePreview && (
                                <div>
                                    <p className="text-xs text-muted-foreground mb-1.5">
                                        {currentImage ? 'Change image' : 'Upload new image'}
                                    </p>
