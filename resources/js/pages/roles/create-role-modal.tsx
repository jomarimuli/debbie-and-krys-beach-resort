...
import { RoleFormData, PermissionCategory } from '@/types';
...
export default function CreateRoleModal({
    ...
    const isCategoryIndeterminate = (categoryPermissions: string[]) => {
        return categoryPermissions.some(p => data.permissions.includes(p)) && !categoryPermissions.every(p => data.permissions.includes(p));
    };
